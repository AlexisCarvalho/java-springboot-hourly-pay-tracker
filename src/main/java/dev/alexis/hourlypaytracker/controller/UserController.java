...
public class UserController {
     ...
     */
    @GetMapping("/profile")
    public ResponseEntity<ProfileResponseDto> getProfile(@CurrentUser Long userId) {
        ProfileResponseDto profile = service.getProfileResponseDtoById(userId);
    ...
    public ResponseEntity<UserResponseDto> getUserById(@PathVariable("userId") Long userId) {
        UserResponseDto userDto = service.getUserResponseDtoById(userId);
